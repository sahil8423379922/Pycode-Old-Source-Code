...
public class condition_programs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_condition_programs);
        ...
        i = new Intent(condition_programs.this, loadprogram.class);
        b = new Bundle();
        ...
        findViewById(R.id.c1).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(condition_programs.this, loadprogram.class));
                String p1 = "96";
    ...
    private void refreshAd() {
        ...
        AdLoader adLoader = builder.withAdListener(new AdListener() {
            ...
            public void onAdFailedToLoad(int i) {
                ...
                //Toast.makeText(condition_programs.this, "Eror in Loading Ad", Toast.LENGTH_SHORT).show();
    ...
    public void onBackPressed() {
        startActivity(new Intent(condition_programs.this,moreprograms.class));
        super.onBackPressed();
    }
}
