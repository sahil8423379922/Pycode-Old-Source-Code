...
public class list_programs extends AppCompatActivity {
    Bundle b;
    Intent i;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        i = new Intent(list_programs.this, loadprogram.class);
        b = new Bundle();

        findViewById(R.id.li1).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                startActivity(new Intent(list_programs.this, loadprogram.class));
                String p1 = "86";
        ...
        findViewById(R.id.li2).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        findViewById(R.id.li3).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        findViewById(R.id.li4).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        findViewById(R.id.li5).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    private void refreshAd() {
        ...
        AdLoader adLoader = builder.withAdListener(new AdListener() {
            ...
            public void onAdFailedToLoad(int i) {
                ...
                Toast.makeText(list_programs.this, "Eror in Loading Ad", Toast.LENGTH_SHORT).show();
    ...
    public void onBackPressed() {
        startActivity(new Intent(list_programs.this,moreprograms.class));
        super.onBackPressed();
    }
}
