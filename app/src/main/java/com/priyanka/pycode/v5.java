...
public class v5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                if (mInterstitialAd.isLoaded()) {
                    ...
                    mInterstitialAd.setAdListener(new AdListener() {
                        ...
                        public void onAdClosed() {
                            super.onAdClosed();
                            startActivity(new Intent(v5.this,Video.class));
                        }
                    });
        ...
        YouTubePlayerView youTubePlayerView4 = findViewById(R.id.keyword_video);
    ...
    private void refreshAd()
    {
        ...
        AdLoader adLoader = builder.withAdListener(new AdListener(){
            ...
            //    Toast.makeText(v5.this, "Eror in Loading Ad", Toast.LENGTH_SHORT).show();
