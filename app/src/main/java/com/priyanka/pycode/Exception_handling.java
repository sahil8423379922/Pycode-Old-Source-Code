...
public class Exception_handling extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = findViewById(R.id.toolbar_eh);
                ...
                if (mInterstitialAd.isLoaded()) {
                    ...
                    mInterstitialAd.setAdListener(new AdListener() {
                        ...
                        public void onAdClosed() {
                            super.onAdClosed();
                            startActivity(new Intent(Exception_handling.this, exception_handiling_middle.class));
                        }
                    });
        ...
        findViewById(R.id.exception_handling_btn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Exception_handling.this, ExceptionHandling.class));
            }
        });

        findViewById(R.id.exception_clause_btn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Exception_handling.this, ExceptionClause.class));
            }
        });
