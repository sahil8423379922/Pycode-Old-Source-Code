...
public class output_in_python extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_output_in_python);
        ...
        Toolbar toolbar = findViewById(R.id.toolbar_input_output);
                ...
                if (mInterstitialAd.isLoaded()) {
                    ...
                    mInterstitialAd.setAdListener(new AdListener() {
                        ...
                        public void onAdClosed() {
                            super.onAdClosed();
                            startActivity(new Intent(output_in_python.this, input_output_middle.class));
                        }
                    });
        ...
        findViewById(R.id.input_in_python_btn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(output_in_python.this, Input.class));
            }
        });
        findViewById(R.id.output_in_python_btn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(output_in_python.this, Output.class));
            }
        });
    ...
    private void refreshAd()
    {
        ...
        AdLoader adLoader = builder.withAdListener(new AdListener(){
            ...
            public void onAdFailedToLoad(int i) {
                ...
                //Toast.makeText(output_in_python.this, "Eror in Loading Ad", Toast.LENGTH_SHORT).show();
