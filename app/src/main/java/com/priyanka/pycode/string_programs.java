...
public class string_programs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        i = new Intent(string_programs.this, loadprogram.class);
        b = new Bundle();

        findViewById(R.id.st1).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                startActivity(new Intent(string_programs.this, loadprogram.class));
                String p1 = "41";
        ...
        findViewById(R.id.st2).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        findViewById(R.id.st3).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        findViewById(R.id.st4).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        findViewById(R.id.st5).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    private void refreshAd() {
        ...
        AdLoader adLoader = builder.withAdListener(new AdListener() {
            ...
            public void onAdFailedToLoad(int i) {
              ...
              //  Toast.makeText(string_programs.this, "Eror in Loading Ad", Toast.LENGTH_SHORT).show();
    ...
    public void onBackPressed() {
        startActivity(new Intent(string_programs.this,moreprograms.class));
        super.onBackPressed();
    }
}
