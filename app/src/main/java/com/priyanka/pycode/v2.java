...
public class v2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                if (mInterstitialAd.isLoaded()) {
                    ...
                    mInterstitialAd.setAdListener(new AdListener() {
                        ...
                        public void onAdClosed() {
                            super.onAdClosed();
                            startActivity(new Intent(v2.this,Video.class));
                        }
                    });
        ...
        YouTubePlayerView youTubePlayerView1 = findViewById(R.id.installation_video);
    ...
    private void refreshAd()
    {
        ...
        AdLoader adLoader = builder.withAdListener(new AdListener(){
            ...
            public void onAdFailedToLoad(int i) {
                ...
                //Toast.makeText(v2.this, "Eror in Loading Ad", Toast.LENGTH_SHORT).show();
