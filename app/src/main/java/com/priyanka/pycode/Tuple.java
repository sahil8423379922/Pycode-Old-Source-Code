...
public class Tuple extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = findViewById(R.id.toolbar_tuple);
                ...
                if (mInterstitialAd.isLoaded()) {
                    ...
                    mInterstitialAd.setAdListener(new AdListener() {
                        ...
                        public void onAdClosed() {
                            super.onAdClosed();
                            startActivity(new Intent(Tuple.this, tuple_middle.class));
                        }
                    });
        ...
        findViewById(R.id.tuple_in_python_btn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Tuple.this, TupleinPython.class));
            }
        });


        findViewById(R.id.accessing_in_tuples_btn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Tuple.this, AcessingTuple.class));
            }
        });

        findViewById(R.id.basic_operation_btn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Tuple.this, BasicOperation.class));
            }
        });
