...
public class dictionary_programs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dictionary_programs);
        ...
        i = new Intent(dictionary_programs.this, loadprogram.class);
        b = new Bundle();
        ...
        findViewById(R.id.d1).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(dictionary_programs.this, loadprogram.class));
                String p1 = "81";
        ...
        findViewById(R.id.d5).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    private void refreshAd() {
        ...
        AdLoader adLoader = builder.withAdListener(new AdListener() {
            ...
            public void onAdFailedToLoad(int i) {
                ...
                //Toast.makeText(dictionary_programs.this, "Eror in Loading Ad", Toast.LENGTH_SHORT).show();
    ...
    public void onBackPressed() {
        startActivity(new Intent(dictionary_programs.this,moreprograms.class));
        super.onBackPressed();
    }
}
