...
public class Modules extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                if (mInterstitialAd.isLoaded()) {
                    ...
                    mInterstitialAd.setAdListener(new AdListener() {
                        ...
                        public void onAdClosed() {
                            super.onAdClosed();
                            startActivity(new Intent(Modules.this, module_middle.class));
                        }
                    });
        ...
        findViewById(R.id.moules_in_python_btn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Modules.this, ModulesinPython.class));
            }
        });


        findViewById(R.id.importing_modules_btn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Modules.this, ImportingModule.class));
            }
        });

        findViewById(R.id.math_module_btn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Modules.this, Mathmodule.class));
            }
        });

        findViewById(R.id.random_module_btn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Modules.this, RandomModule.class));
            }
        });
