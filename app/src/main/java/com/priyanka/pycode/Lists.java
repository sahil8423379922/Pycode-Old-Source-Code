...
public class Lists extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                if (mInterstitialAd.isLoaded()) {
                    ...
                    mInterstitialAd.setAdListener(new AdListener() {
                        ...
                        public void onAdClosed() {
                            super.onAdClosed();
                            startActivity(new Intent(Lists.this, list_middle.class));
                        }
                    });
        ...
        findViewById(R.id.list_in_python_btn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Lists.this, Lists_in_Python.class));
            }
        });

        findViewById(R.id.creating_list_btn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Lists.this, Creating_a_List.class));
            }
        });

        findViewById(R.id.operation_on_list_btn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Lists.this, Operation_on_List.class));
            }
        });

        findViewById(R.id.accesing_element_btn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Lists.this, Acessing_Element.class));
            }
        });
