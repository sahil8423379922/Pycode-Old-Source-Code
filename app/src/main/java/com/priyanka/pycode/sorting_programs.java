...
public class sorting_programs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sorting_programs);
        ...
        i = new Intent(sorting_programs.this, loadprogram.class);
        b = new Bundle();
        ...
        findViewById(R.id.s1).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(sorting_programs.this, loadprogram.class));
                String p1 = "56";
    ...
    private void refreshAd() {
        ...
        AdLoader adLoader = builder.withAdListener(new AdListener() {
            ...
            public void onAdFailedToLoad(int i) {
                ...
                //Toast.makeText(sorting_programs.this, "Eror in Loading Ad", Toast.LENGTH_SHORT).show();
    ...
    public void onBackPressed() {
        startActivity(new Intent(sorting_programs.this,moreprograms.class));
        super.onBackPressed();
    }
}
