...
public class v4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                if (mInterstitialAd.isLoaded()) {
                    ...
                    mInterstitialAd.setAdListener(new AdListener() {
                        ...
                        public void onAdClosed() {
                            super.onAdClosed();
                            startActivity(new Intent(v4.this,Video.class));
                        }
                    });
        ...
        YouTubePlayerView youTubePlayerView2 = findViewById(R.id.datatype_video);
    ...
    private void refreshAd()
    {
        ...
        AdLoader adLoader = builder.withAdListener(new AdListener(){
            ...
            public void onAdFailedToLoad(int i) {
               ...
               // Toast.makeText(v4.this, "Eror in Loading Ad", Toast.LENGTH_SHORT).show();
