...
public class v6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                if (mInterstitialAd.isLoaded()) {
                    ...
                    mInterstitialAd.setAdListener(new AdListener() {
                        ...
                        public void onAdClosed() {
                            super.onAdClosed();
                            startActivity(new Intent(v6.this,Video.class));
                        }
                    });
        ...
        YouTubePlayerView youTubePlayerView5 = findViewById(R.id.delimeter_video);
    ...
    private void refreshAd()
    {
        ...
        AdLoader adLoader = builder.withAdListener(new AdListener(){
            ...
            public void onAdFailedToLoad(int i) {
               ...
               // Toast.makeText(v6.this, "Eror in Loading Ad", Toast.LENGTH_SHORT).show();
