...
public class list_function_and_methods extends AppCompatActivity {
    private WebView wb;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_function_and_methods);
        progressBar = findViewById(R.id.progress);
        Toolbar toolbar = findViewById(R.id.toolbar_list_function_and_methods);
    ...
    private void BottomNavigationCall() {
        findViewById(R.id.home).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(list_function_and_methods.this,startcourse.class));
            }
        });
        ...
        findViewById(R.id.exit).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(list_function_and_methods.this);
        ...
        findViewById(R.id.run).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(list_function_and_methods.this,CodeTerminal.class));
            }
        });
        ...
        findViewById(R.id.video).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(list_function_and_methods.this,Video.class ));
            }
        });
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.bookmark) {
            ...
            if (count != 0) {
                ...
                boolean check = mydatabase.insertdata("Methods in List");
                if (check == true) {
                    item.setIcon(R.drawable.ic_bookmark_black_24dp);
                }
